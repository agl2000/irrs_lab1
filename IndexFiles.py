...
if __name__ == '__main__':
    ...
    client = Elasticsearch(hosts=["http://localhost:9200"], timeout=1000)
    try:
    ...
    try:
        ...
        # This will print out details about the failed documents
        print("Bulk indexing failed")
        print(e.errors)  # This contains detailed error information for each failed document
